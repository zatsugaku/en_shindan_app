  ...
  <section style="${styles.container}">
    ...
    <div style="${styles.contentBox}">
      ...
      <div style="margin: 40px 0;">
        <h4 style="font-size: 22px; color: #667eea; margin-bottom: 15px;">理論1: 四柱推命</h4>
        <p style="font-size: 16px; line-height: 1.9;">
          1000年以上の歴史を持つ東洋統計学。<br>
          生年月日から人生の流れを読み解く、最高峰の理論。
        </p>
      </div>

      <div style="margin: 40px 0;">
        <h4 style="font-size: 22px; color: #667eea; margin-bottom: 15px;">理論2: 名前音韻学</h4>
        <p style="font-size: 16px; line-height: 1.9;">
          名前の音の響きが持つ力の研究。<br>
          呼ばれるたびにあなたに影響を与えるエネルギー。
        </p>
      </div>

      <div style="margin: 40px 0;">
        <h4 style="font-size: 22px; color: #667eea; margin-bottom: 15px;">理論3: 自然現象調和理論</h4>
        <p style="font-size: 16px; line-height: 1.9;">
          人間と自然のリズムの関係性。<br>
          12の自然現象と人間の個性の関係を解明。
        </p>
      ...
      <div style="margin: 40px 0;">
        <h4 style="font-size: 22px; color: #667eea; margin-bottom: 15px;">理論4: バイオリズム</h4>
        <p style="font-size: 16px; line-height: 1.9;">
          人生の波を科学的に分析。<br>
          10の状態を約30-40日周期で巡るリズム。
        </p>
      </div>
    </div>
  </section>
