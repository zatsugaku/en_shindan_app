...
<head>
  ...
  <title>縁診断 - あなたの縁を知り、活かし、開運する</title>
  <meta name="description" content="3分で分かる、あなたの縁のかたち。統計学×伝統理論が導く、完全無料の縁診断。">
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <section style="${styles.container}">
    ...
    <div style="${styles.contentBox}">
      <p style="font-size: 18px; line-height: 2.0;">
        ...
        それは、古来より日本人が大切にしてきた、<br>
        人と人、人と場所、人と出来事を結ぶ<br>
        <strong style="color: #667eea;">「目に見えないつながりの力」</strong>です。<br><br>

        仏教では「因縁」として、<br>
        神道では「ムスビ」として、<br>
        数千年にわたり研究され、体系化されてきた<br>
        深い智慧の結晶。<br><br>
    ...
    <h3 style="font-size: 28px; margin: 60px 0 30px; color: #333;">なぜ縁を知ることが大切なのか</h3>
    ...
    <div style="${styles.contentBox}">
      ...
      <p style="font-size: 18px; line-height: 2.0; margin-bottom: 30px;">
        縁を知るだけでは、何も変わりません。<br>
        大切なのは、その縁を<strong>「活かす」</strong>こと。
      </p>
      ...
      <p style="font-size: 18px; line-height: 2.0; margin-top: 30px;">
        ...
        <strong>縁が「開く」（開縁 - かいえん）</strong><br>
        　　→ 新しい出会い、良いご縁が自然と訪れる<br><br>

        <strong>運が「開ける」（開運 - かいうん）</strong><br>
        　　→ 物事がスムーズに進み、望む方向へ
      </p>
    </div>
  </section>
  ...
  <section style="${styles.container}">
    ...
    <div style="${styles.contentBox}">
      ...
      <p style="font-size: 20px; font-weight: bold; margin: 30px 0 20px;">【五行のエネルギー】5種類</p>
      <ul style="list-style: none; padding: 0;">
        <li style="padding: 10px 0; font-size: 18px;">・<strong>木</strong>（もく）- 成長・発展・柔軟性</li>
        <li style="padding: 10px 0; font-size: 18px;">・<strong>火</strong>（か）- 情熱・活動・表現</li>
        <li style="padding: 10px 0; font-size: 18px;">・<strong>土</strong>（ど）- 安定・包容・基盤</li>
        <li style="padding: 10px 0; font-size: 18px;">・<strong>金</strong>（きん）- 整理・清廉・完成</li>
        <li style="padding: 10px 0; font-size: 18px;">・<strong>水</strong>（すい）- 流動・浄化・知恵</li>
      </ul>

      <p style="font-size: 20px; font-weight: bold; margin: 40px 0 20px;">【自然現象】12種類</p>
      <p style="font-size: 16px; line-height: 1.8; color: #666;">
        春霞・夏雨・彩雲・朝日・夕陽・秋風<br>
        冬陽・朧月・霜夜・氷刃・春雷・豊穣
      </p>

      <p style="font-size: 24px; text-align: center; margin: 40px 0; font-weight: bold; color: #667eea;">
        5 × 12 = 60通りの組み合わせ
      </p>
  ...
  <section style="${styles.container}">
    ...
    <div style="${styles.highlightBox}">
      ...
      <p style="font-size: 18px; line-height: 2.1; letter-spacing: 1px;">
        一般的な診断の3-5倍のボリューム。<br>
        読み応えのある、本格的な内容です。
      </p>
    </div>
  </section>
  ...
  <section style="${styles.container}">
    <h2 style="${styles.sectionTitle}">
      統計学と古来の智慧が、<br>あなたの縁を紐解く
    </h2>

    <div style="${styles.contentBox}">
      <p style="font-size: 18px; line-height: 2.0; margin-bottom: 30px; text-align: center;">
        当診断システムは、3つの理論を統合し、<br>
        あなたの縁を深く理解するための<br>
        <strong style="font-size: 20px; color: #2d1b4e;">新しいアプローチ</strong>です。
      </p>

      <div style="margin: 40px 0;">
        <h4 style="font-size: 22px; color: #2d1b4e; margin-bottom: 15px; letter-spacing: 1px;">理論1: 四柱推命</h4>
        <p style="font-size: 16px; line-height: 2.1; letter-spacing: 0.5px;">
          1000年以上の歴史を持つ東洋統計学。<br>
          生年月日から人生の流れを読み解く、最高峰の理論。<br>
          あなたの60分類を決定し、基本的なエネルギー特性を解析します。
        </p>
      </div>

      <div style="margin: 40px 0;">
        <h4 style="font-size: 22px; color: #2d1b4e; margin-bottom: 15px; letter-spacing: 1px;">理論2: 名前音韻学</h4>
        <p style="font-size: 16px; line-height: 2.1; letter-spacing: 0.5px;">
          名前の音の響きが持つ力の研究。<br>
          呼ばれるたびにあなたに影響を与えるエネルギー。<br>
          母音と子音の組み合わせから、15要素で分析し、<br>
          3つの縁タイプ（結縁・深縁・広縁）を判定します。
        </p>
      </div>

      <div style="margin: 40px 0;">
        <h4 style="font-size: 22px; color: #2d1b4e; margin-bottom: 15px; letter-spacing: 1px;">理論3: 自然現象調和理論</h4>
        <p style="font-size: 16px; line-height: 2.1; letter-spacing: 0.5px;">
          人間と自然のリズムの関係性。<br>
          12の自然現象（春霞・夏雨・彩雲・朝日・夕陽・秋風・冬陽・朧月・霜夜・氷刃・春雷・豊穣）<br>
          それぞれが持つ特性と、人間の個性の関係を解明。<br>
          あなたと調和する自然現象を特定し、最適な環境を提案します。
        </p>
      </div>
    </div>
  </section>
  ...
  <section style="${styles.finalCta}">
    ...
    <p style="${styles.finalCtaText}">
      ...
      縁を知り、それを活かす行動を選ぶことで、<br>
      あなたの人生は、自然に、心地よく、<br>
      良い方向へ流れ始めます。<br><br>

      <strong style="font-size: 22px;">たった3分で、あなたの縁を知り、<br>
      人生を開く第一歩を。</strong>
    </p>
  ...
  <!-- フッター -->
  <footer style="text-align: center; padding: 40px 20px; background: #f5f5f5; margin-top: 80px;">
    <p style="font-size: 14px; color: #666;">
      © 2024 縁診断 | <a href="/privacy" style="color: #667eea; text-decoration: none;">プライバシーポリシー</a>
    </p>
  </footer>
